...
- Serif mode with a strong Chinese serif fallback and editorial Latin typography
- Sans mode with system CJK text and an Anthropic-inspired Latin stack
...
No user data is collected or transmitted. No analytics, advertising, tracking, remote code, or network requests.

## Support URL

https://github.com/ensomnia16/chatgpt-anthropic-theme/issues

## Privacy policy URL

https://github.com/ensomnia16/chatgpt-anthropic-theme/blob/main/PRIVACY.md
